...
import { BrowserDrivenAvatar } from "./BrowserDrivenAvatar";
import {
  answerBetQuestion,
  ...
  return (
    ...
    >
      ...
      <div className="bet-assistant-launcher-zone">
        ...
        >
          ...
          {copilotMode === "duo" ? (
            ...
            <div className="launcher-main-avatar launcher-browser-avatar">
              <BrowserDrivenAvatar
                ...
                image={copilotIdentity.image}
                name={copilotIdentity.name}
      ...
      <style jsx>{`
        ...
        .launcher-browser-avatar :global(.browser-avatar) {
          border-radius: 31px;
        }
